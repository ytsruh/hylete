...
//     JSON API mirrors, plus the public content pages (/showcase,
//     /privacy, /about) which never redirect authenticated visitors away. /forgot and /reset must be reachable logged-out
