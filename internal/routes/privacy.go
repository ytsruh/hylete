...
// tracker application. This file contains the public privacy
// policy page served at /privacy.
package routes
...
// Privacy renders the public privacy policy page at "/privacy".
//
// "/privacy" is in the auth middleware's public-route list, so it is
