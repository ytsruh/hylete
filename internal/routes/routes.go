...
func registerAPIRoutes(e *echo.Echo, h *Handler) {
	...
	// BetaFeature switch). Reports are generated by the weekly
	// cron; build is the idempotent on-demand refresh.
	e.GET("/api/v1/coach/weekly:latest", h.APICoachLatest)
	e.GET("/api/v1/coach/weekly", h.APICoachHistory)
	e.POST("/api/v1/coach/weekly/build", h.APICoachBuild)
	e.POST("/api/v1/coach/weekly/:id/read", h.APICoachMarkRead)
